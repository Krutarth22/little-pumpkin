...
function setup(fetchImpl,values={},simple=false) {
...
(async()=>{
 ...
 t=setup(async()=>({ok:true}),{},true); await t.send(); assert.equal(t.nodes['rsvp-summary'].textContent,'Test Family • Attending');
